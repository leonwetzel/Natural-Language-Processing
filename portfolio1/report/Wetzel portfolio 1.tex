...
$$\text{cosine}(\text{Apple}, \text{Snow}) = \frac{2*2 + 1*3 + 5*2}{\sqrt{2^2 + 1^2 + 5^2} \sqrt{2^2 + 3^2 + 2^2}} = \frac{17}{\sqrt{30} \sqrt{19}} \approx 0,71205$$

$$\text{cosine}(\text{Snow}, \text{Ski}) = \frac{2*0 + 3*4 + 2*5}{\sqrt{2^2 + 3^2 + 2^2} \sqrt{0^2 + 4^2 + 5^2}} = \frac{12}{\sqrt{17} \sqrt{41}} \approx 0,45453$$
